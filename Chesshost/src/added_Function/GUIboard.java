...
public class GUIboard extends JFrame{
	...
	public void menuAdd() {
		...
		load.addActionListener(this.load1);
		restart.addActionListener(this.restart1);
	...
	class LocationListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(co1.isRunnig) Chess.setStr(str.concat(new Character(c2).toString()));
			else System.out.println("You cant control Black unit");
		}
	}
